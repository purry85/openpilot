...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
    ...
    if LQR_enabled:
      ...
      ret.lateralTuning.indi.innerLoopGainBP = [10., 41.]
      ret.lateralTuning.indi.innerLoopGainV = [5.5, 8.0]
      ret.lateralTuning.indi.outerLoopGainBP = [10., 41.]
      ret.lateralTuning.indi.outerLoopGainV = [4.5, 7.0]
      ret.lateralTuning.indi.timeConstantBP = [10., 41.]
    ...
    ret.longitudinalTuning.kfV = [0.8, 0.5, 0.2]
